    ...
    <div className="projects-page">
      <div className="container">
        ...
        <div className="projects-grid">
          {projects.map(([number, types, title, desc, tags, cta], index) => (
            <div className={`project-card reveal delay-${((index % 3) + 1) * 100}`} key={title}>
              ...
              <div className="project-body">
                ...
                <div className="project-links"><a href="#" className="btn btn-outline btn-sm">📄 {cta}</a><a href="https://github.com/Oscartetteh" className="btn btn-ghost btn-sm" target="_blank" rel="noreferrer">GitHub</a></div>
              </div>
            </div>
          ))}
        </div>
